...
#define OpenWorldStarterPlugin_Plugins_OWSPlugin_Source_OWSPlugin_Public_OWSAdvancedProjectile_h_83_RPC_WRAPPERS \
	virtual void Explode_Implementation(FVector const& HitLocation, FVector const& HitNormal, UPrimitiveComponent* HitComp); \
	virtual void DamageImpactedActor_Implementation(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector const& HitLocation, FVector const& HitNormal); \
	virtual void ProcessHit_Implementation(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector const& HitLocation, FVector const& HitNormal); \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->Explode_Implementation(Z_Param_Out_HitLocation,Z_Param_Out_HitNormal,Z_Param_HitComp); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->DamageImpactedActor_Implementation(Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_Out_HitLocation,Z_Param_Out_HitNormal); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->ProcessHit_Implementation(Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_Out_HitLocation,Z_Param_Out_HitNormal); \
		P_NATIVE_END; \
	} \
 \
