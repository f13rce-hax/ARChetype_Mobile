...
// Cross Module References
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct();
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ItemsToAdd_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_ItemsToAdd;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ItemsToAdd_Inner;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd = { "ItemsToAdd", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSInventory_eventAddItemsFromInventoryItemStruct_Parms, ItemsToAdd), METADATA_PARAMS(Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd_Inner = { "ItemsToAdd", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FInventoryItemStruct, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::NewProp_ItemsToAdd_Inner,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::Function_MetaDataParams[] = {
		{ "Category", "Inventory" },
		{ "ModuleRelativePath", "Public/OWSInventory.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOWSInventory, nullptr, "AddItemsFromInventoryItemStruct", sizeof(OWSInventory_eventAddItemsFromInventoryItemStruct_Parms), Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct_Statics::FuncParams);
		}
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOWSInventory_FindItemIndex_Statics::NewProp_ItemName = { "ItemName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSInventory_eventFindItemIndex_Parms, ItemName), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOWSInventory_FindItemIndex_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSInventory_FindItemIndex_Statics::NewProp_ItemName,
	};
#if WITH_METADATA
	...
	struct Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_inOwningPlayerCharacter;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::NewProp_inOwningPlayerCharacter = { "inOwningPlayerCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSInventory_eventSetOwningPlayerCharacter_Parms, inOwningPlayerCharacter), Z_Construct_UClass_AOWSCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::NewProp_inOwningPlayerCharacter,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::Function_MetaDataParams[] = {
		{ "Category", "Inventory" },
		{ "ModuleRelativePath", "Public/OWSInventory.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOWSInventory, nullptr, "SetOwningPlayerCharacter", sizeof(OWSInventory_eventSetOwningPlayerCharacter_Parms), Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOWSInventory_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOWSInventory_AddItemsFromInventoryItemStruct, "AddItemsFromInventoryItemStruct" }, // 881198025
		...
		{ &Z_Construct_UFunction_UOWSInventory_FindItemIndex, "FindItemIndex" }, // 3590173708
		...
		{ &Z_Construct_UFunction_UOWSInventory_SetOwningPlayerCharacter, "SetOwningPlayerCharacter" }, // 1258499020
	...
	IMPLEMENT_CLASS(UOWSInventory, 4107661041);
