...
// Cross Module References
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory();
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems();
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory();
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSCharacter_GetGameMode();
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage();
...
static struct FScriptStruct_OWSPlugin_StaticRegisterNativesFAbilityStruct
{
	...
	static FName NAME_AOWSCharacter_Client_AddItemToInventory = FName(TEXT("Client_AddItemToInventory"));
	void AOWSCharacter::Client_AddItemToInventory(FName const& InventoryName, const FString& ItemName, const int32 StackSize, const int32 InSlotNumber, const int32 NumberOfUsesLeft, const int32 Condition, const FString& PerInstanceCustomData, const FGuid UniqueItemGUID)
	{
		OWSCharacter_eventClient_AddItemToInventory_Parms Parms;
		Parms.InventoryName=InventoryName;
		Parms.ItemName=ItemName;
		Parms.StackSize=StackSize;
		Parms.InSlotNumber=InSlotNumber;
		Parms.NumberOfUsesLeft=NumberOfUsesLeft;
		Parms.Condition=Condition;
		Parms.PerInstanceCustomData=PerInstanceCustomData;
		Parms.UniqueItemGUID=UniqueItemGUID;
		ProcessEvent(FindFunctionChecked(NAME_AOWSCharacter_Client_AddItemToInventory),&Parms);
	}
	static FName NAME_AOWSCharacter_Client_AddItemToLocalInventoryItems = FName(TEXT("Client_AddItemToLocalInventoryItems"));
	void AOWSCharacter::Client_AddItemToLocalInventoryItems(const FString& ItemName, bool ItemCanStack, bool IsUsable, bool IsConsumedOnUse, const int32 ItemTypeID, const FString& TextureToUseForIcon)
	{
		OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms Parms;
		Parms.ItemName=ItemName;
		Parms.ItemCanStack=ItemCanStack ? true : false;
		Parms.IsUsable=IsUsable ? true : false;
		Parms.IsConsumedOnUse=IsConsumedOnUse ? true : false;
		Parms.ItemTypeID=ItemTypeID;
		Parms.TextureToUseForIcon=TextureToUseForIcon;
		ProcessEvent(FindFunctionChecked(NAME_AOWSCharacter_Client_AddItemToLocalInventoryItems),&Parms);
	}
	static FName NAME_AOWSCharacter_Client_CreateHUDInventory = FName(TEXT("Client_CreateHUDInventory"));
	void AOWSCharacter::Client_CreateHUDInventory(FName InventoryName, int32 Size)
	{
		OWSCharacter_eventClient_CreateHUDInventory_Parms Parms;
		Parms.InventoryName=InventoryName;
		Parms.Size=Size;
		ProcessEvent(FindFunctionChecked(NAME_AOWSCharacter_Client_CreateHUDInventory),&Parms);
	}
	...
	void AOWSCharacter::StaticRegisterNativesAOWSCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "Client_AddItemToInventory", &AOWSCharacter::execClient_AddItemToInventory },
			{ "Client_AddItemToLocalInventoryItems", &AOWSCharacter::execClient_AddItemToLocalInventoryItems },
			{ "Client_CreateHUDInventory", &AOWSCharacter::execClient_CreateHUDInventory },
			...
			{ "GetGameMode", &AOWSCharacter::execGetGameMode },
			...
			{ "OnRep_InventoriesToManage", &AOWSCharacter::execOnRep_InventoriesToManage },
	...
	struct Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_UniqueItemGUID_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_UniqueItemGUID = { "UniqueItemGUID", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, UniqueItemGUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_UniqueItemGUID_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_UniqueItemGUID_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_PerInstanceCustomData_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_PerInstanceCustomData = { "PerInstanceCustomData", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, PerInstanceCustomData), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_PerInstanceCustomData_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_PerInstanceCustomData_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_Condition_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_Condition = { "Condition", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, Condition), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_Condition_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_Condition_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_NumberOfUsesLeft_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_NumberOfUsesLeft = { "NumberOfUsesLeft", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, NumberOfUsesLeft), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_NumberOfUsesLeft_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_NumberOfUsesLeft_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InSlotNumber_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InSlotNumber = { "InSlotNumber", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, InSlotNumber), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InSlotNumber_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InSlotNumber_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_StackSize_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_StackSize = { "StackSize", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, StackSize), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_StackSize_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_StackSize_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_ItemName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_ItemName = { "ItemName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, ItemName), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_ItemName_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_ItemName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InventoryName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InventoryName = { "InventoryName", nullptr, (EPropertyFlags)0x0010000008000082, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToInventory_Parms, InventoryName), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InventoryName_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InventoryName_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_UniqueItemGUID,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_PerInstanceCustomData,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_Condition,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_NumberOfUsesLeft,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InSlotNumber,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_StackSize,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_ItemName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::NewProp_InventoryName,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSCharacter, nullptr, "Client_AddItemToInventory", sizeof(OWSCharacter_eventClient_AddItemToInventory_Parms), Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x01820CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TextureToUseForIcon_MetaData[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_TextureToUseForIcon_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_TextureToUseForIcon = { "TextureToUseForIcon", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms, TextureToUseForIcon), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_TextureToUseForIcon_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_TextureToUseForIcon_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemTypeID_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemTypeID = { "ItemTypeID", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms, ItemTypeID), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemTypeID_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemTypeID_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	void Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse_SetBit(void* Obj)
	{
		((OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms*)Obj)->IsConsumedOnUse = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse = { "IsConsumedOnUse", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms), &Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse_SetBit, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	void Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable_SetBit(void* Obj)
	{
		((OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms*)Obj)->IsUsable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable = { "IsUsable", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms), &Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable_SetBit, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	void Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack_SetBit(void* Obj)
	{
		((OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms*)Obj)->ItemCanStack = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack = { "ItemCanStack", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms), &Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack_SetBit, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemName = { "ItemName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms, ItemName), METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemName_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemName_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_TextureToUseForIcon,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemTypeID,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsConsumedOnUse,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_IsUsable,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemCanStack,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::NewProp_ItemName,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSCharacter, nullptr, "Client_AddItemToLocalInventoryItems", sizeof(OWSCharacter_eventClient_AddItemToLocalInventoryItems_Parms), Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x01020CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics
	{
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::NewProp_Size = { "Size", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_CreateHUDInventory_Parms, Size), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::NewProp_InventoryName = { "InventoryName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventClient_CreateHUDInventory_Parms, InventoryName), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::NewProp_Size,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::NewProp_InventoryName,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSCharacter, nullptr, "Client_CreateHUDInventory", sizeof(OWSCharacter_eventClient_CreateHUDInventory_Parms), Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x01020CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics
	{
		struct OWSCharacter_eventGetGameMode_Parms
		{
			AOWSGameMode* ReturnValue;
		};
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSCharacter_eventGetGameMode_Parms, ReturnValue), Z_Construct_UClass_AOWSGameMode_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::Function_MetaDataParams[] = {
		{ "Category", "Game Mode" },
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
		{ "ToolTip", "Get Game Mode" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSCharacter, nullptr, "GetGameMode", sizeof(OWSCharacter_eventGetGameMode_Parms), Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSCharacter_GetGameMode()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSCharacter_GetGameMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSCharacter, nullptr, "OnRep_InventoriesToManage", 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LocalInventoryItems_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_LocalInventoryItems;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_LocalInventoryItems_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bShouldAutoLoadInventoriesToManage_MetaData[];
#endif
		static void NewProp_bShouldAutoLoadInventoriesToManage_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bShouldAutoLoadInventoriesToManage;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWSCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AOWSCharacter_Client_AddItemToInventory, "Client_AddItemToInventory" }, // 1457102807
		{ &Z_Construct_UFunction_AOWSCharacter_Client_AddItemToLocalInventoryItems, "Client_AddItemToLocalInventoryItems" }, // 3058038248
		{ &Z_Construct_UFunction_AOWSCharacter_Client_CreateHUDInventory, "Client_CreateHUDInventory" }, // 2981724377
		...
		{ &Z_Construct_UFunction_AOWSCharacter_GetGameMode, "GetGameMode" }, // 432005734
		...
		{ &Z_Construct_UFunction_AOWSCharacter_OnRep_InventoriesToManage, "OnRep_InventoriesToManage" }, // 2949712519
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AOWSCharacter_Statics::NewProp_InventoriesToManage_MetaData[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
		{ "ToolTip", "UPROPERTY(Transient, ReplicatedUsing = OnRep_InventoriesToManage)" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOWSCharacter_Statics::NewProp_InventoriesToManage = { "InventoriesToManage", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOWSCharacter, InventoriesToManage), METADATA_PARAMS(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_InventoriesToManage_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_InventoriesToManage_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems_MetaData[] = {
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems = { "LocalInventoryItems", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOWSCharacter, LocalInventoryItems), METADATA_PARAMS(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems_Inner = { "LocalInventoryItems", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FInventoryItemStruct, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage_MetaData[] = {
		{ "Category", "Inventory" },
		{ "ModuleRelativePath", "Public/OWSCharacter.h" },
		{ "ToolTip", "HUD Inventory System" },
	};
#endif
	void Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage_SetBit(void* Obj)
	{
		((AOWSCharacter*)Obj)->bShouldAutoLoadInventoriesToManage = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage = { "bShouldAutoLoadInventoriesToManage", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AOWSCharacter), &Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage_SetBit, METADATA_PARAMS(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage_MetaData, ARRAY_COUNT(Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AOWSCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AOWSCharacter_Statics::NewProp_LocalInventoryItems_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AOWSCharacter_Statics::NewProp_bShouldAutoLoadInventoriesToManage,
	...
	IMPLEMENT_CLASS(AOWSCharacter, 638075021);
