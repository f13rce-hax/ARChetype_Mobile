...
// Cross Module References
	...
	OWSPLUGIN_API UFunction* Z_Construct_UFunction_AOWSGameMode_FindItemDefinition();
...
static struct FScriptStruct_OWSPlugin_StaticRegisterNativesFZoneInstanceStruct
{
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSGameMode_eventFindItemDefinition_Parms, ReturnValue), Z_Construct_UScriptStruct_FInventoryItemStruct, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::NewProp_ItemName = { "ItemName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSGameMode_eventFindItemDefinition_Parms, ItemName), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::NewProp_ItemName,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::Function_MetaDataParams[] = {
		{ "Category", "Inventory" },
		{ "ModuleRelativePath", "Public/OWSGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AOWSGameMode, nullptr, "FindItemDefinition", sizeof(OWSGameMode_eventFindItemDefinition_Parms), Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AOWSGameMode_FindItemDefinition()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AOWSGameMode_FindItemDefinition_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWSGameMode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AOWSGameMode_FindItemDefinition, "FindItemDefinition" }, // 410846471
	...
	IMPLEMENT_CLASS(AOWSGameMode, 3063738348);
