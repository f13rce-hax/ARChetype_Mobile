...
static struct FScriptStruct_OWSPlugin_StaticRegisterNativesFRepUTProjMovement
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::NewProp_Hit_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSAdvancedProjectile_eventDamageImpactedActor_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::NewProp_Hit_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::NewProp_Hit_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor_Statics::NewProp_Hit,
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::NewProp_Hit_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSAdvancedProjectile_eventExplode_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::NewProp_Hit_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::NewProp_Hit_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSAdvancedProjectile_Explode_Statics::NewProp_Hit,
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::NewProp_Hit_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OWSAdvancedProjectile_eventProcessHit_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::NewProp_Hit_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::NewProp_Hit_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit_Statics::NewProp_Hit,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWSAdvancedProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOWSAdvancedProjectile_DamageImpactedActor, "DamageImpactedActor" }, // 1044382201
		{ &Z_Construct_UFunction_AOWSAdvancedProjectile_Explode, "Explode" }, // 1342623913
		...
		{ &Z_Construct_UFunction_AOWSAdvancedProjectile_ProcessHit, "ProcessHit" }, // 2253763417
	...
	IMPLEMENT_CLASS(AOWSAdvancedProjectile, 1525075317);
